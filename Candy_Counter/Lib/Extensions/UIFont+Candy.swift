...
extension UIFont {
    ...
    // MARK: - Custom Font methods
    class func totalCandyTextFieldFont() -> UIFont {
        return UIFont(name:"True Crimes", size: 55.0)!
    }
    
    class func candyTotalCountTextFieldFont() -> UIFont {
        return UIFont(name: "True Crimes", size: 45.0)!
    }
    
    class func candyCountTextFieldFont() -> UIFont {
        return UIFont(name: "True Crimes", size: 35.0)!
    }
    
    
    class func appFontOfSize(size: CGFloat) -> UIFont {
        return UIFont(name: "True Crimes", size: size)!
    }
